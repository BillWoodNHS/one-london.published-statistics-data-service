{% macro create_sidecar_table(database_name, schema_name, table_name) %}
    {{ return(adapter.dispatch('create_sidecar_table')(database_name, schema_name, table_name)) }}
{% endmacro %}

{% macro default__create_sidecar_table(database_name, schema_name, table_name) %}
