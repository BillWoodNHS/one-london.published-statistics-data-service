{% macro create_max_publication_view(database_name, presentation_schema, view_name, presentation_base_view, reporting_columns, period_coverage) %}
    {{ return(adapter.dispatch('create_max_publication_view')(database_name, presentation_schema, view_name, presentation_base_view, reporting_columns, period_coverage)) }}
{% endmacro %}

{% macro default__create_max_publication_view(database_name, presentation_schema, view_name, presentation_base_view, reporting_columns, period_coverage) %}
