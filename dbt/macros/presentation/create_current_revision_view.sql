{% macro create_current_revision_view(database_name, presentation_schema, view_name, max_publication_view, reporting_columns, period_coverage) %}
    {{ return(adapter.dispatch('create_current_revision_view')(database_name, presentation_schema, view_name, max_publication_view, reporting_columns, period_coverage)) }}
{% endmacro %}

{% macro default__create_current_revision_view(database_name, presentation_schema, view_name, max_publication_view, reporting_columns, period_coverage) %}
